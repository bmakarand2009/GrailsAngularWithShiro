...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=10">
        <title>angular-http-auth/app/login.js at gh-pages · witoldsz/angular-http-auth</title>
...
<meta content="SUFMVTrfWItEXNZAAyauyPlrOjktg4atyN1EHRE1cHU=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-fc46856b3ad905365f892bf463b1e1c0fd84764e.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="7e309922140cc9fe6a44cd4384c566d3">
        ...
        <link data-pjax-transient rel='permalink' href='/witoldsz/angular-http-auth/blob/107110108794e48d63d69d4e39748050e6c6378f/app/login.js'>
...
<!-- blob contrib key: blob_contributors:v21:dddbb9ad542a50f8683cb78c1773ac13 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/witoldsz/angular-http-auth/blob/gh-pages/app/login.js"
                 data-name="gh-pages"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/witoldsz/angular-http-auth/blob/master/app/login.js"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
  ...
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://0.gravatar.com/avatar/59336020fe9955579916919d9573a199?d=https%3A%2F%2Fidenticons.github.com%2F23549bc35e5c15db60acf88b0522f1ad.png&amp;r=x&amp;s=140" width="24" />
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img height="24" src="https://0.gravatar.com/avatar/59336020fe9955579916919d9573a199?d=https%3A%2F%2Fidenticons.github.com%2F23549bc35e5c15db60acf88b0522f1ad.png&amp;r=x&amp;s=140" width="24" />
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards js-conduit-openfile-check"
               href="github-mac://openRepo/https://github.com/witoldsz/angular-http-auth?branch=gh-pages&amp;filepath=app%2Flogin.js"
               data-url="github-mac://openRepo/https://github.com/witoldsz/angular-http-auth?branch=gh-pages&amp;filepath=app%2Flogin.js"
               ...
               data-failed-title="Your version of GitHub for Mac is too old to open this file. Try checking for updates.">
                ...
                <a class="minibutton tooltipped upwards"
                   ...
                   href="/witoldsz/angular-http-auth/edit/gh-pages/app/login.js"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/witoldsz/angular-http-auth/raw/gh-pages/app/login.js" class="button minibutton " id="raw-url">Raw</a>
            <a href="/witoldsz/angular-http-auth/blame/gh-pages/app/login.js" class="button minibutton ">Blame</a>
          <a href="/witoldsz/angular-http-auth/commits/gh-pages/app/login.js" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/witoldsz/angular-http-auth/delete/gh-pages/app/login.js"
...
<span id="L12" rel="#L12">12</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="p">(</span><span class="kd">function</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC2'>&nbsp;&nbsp;<span class="s1">&#39;use strict&#39;</span><span class="p">;</span></div><div class='line' id='LC3'>&nbsp;&nbsp;<span class="nx">angular</span><span class="p">.</span><span class="nx">module</span><span class="p">(</span><span class="s1">&#39;login&#39;</span><span class="p">,[</span><span class="s1">&#39;http-auth-interceptor&#39;</span><span class="p">])</span></div><div class='line' id='LC4'>&nbsp;&nbsp;</div><div class='line' id='LC5'>&nbsp;&nbsp;<span class="p">.</span><span class="nx">controller</span><span class="p">(</span><span class="s1">&#39;LoginController&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">$scope</span><span class="p">,</span> <span class="nx">$http</span><span class="p">,</span> <span class="nx">authService</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nx">$scope</span><span class="p">.</span><span class="nx">submit</span> <span class="o">=</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nx">$http</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">&#39;auth/login&#39;</span><span class="p">).</span><span class="nx">success</span><span class="p">(</span><span class="kd">function</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nx">authService</span><span class="p">.</span><span class="nx">loginConfirmed</span><span class="p">();</span></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">});</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC11'>&nbsp;&nbsp;<span class="p">});</span></div><div class='line' id='LC12'><span class="p">})();</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.06157s from github-fe129-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
